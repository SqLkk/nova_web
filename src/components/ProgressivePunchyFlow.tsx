...
export const ProgressivePunchyFlow: React.FC<ProgressivePunchyFlowProps> = ({ onNavigateToDemo }) => {
  ...
  return (
    <div className="bg-[#08060B] relative">
      ...
      {/* Sticky Top-Center Scroll Progress Pill */}
      <div className="sticky top-20 z-30 flex justify-center pointer-events-none mb-4 px-4">
      ...
      {steps.map((item) => {
        ...
        return (
          <section
            ...
            id={`step-${item.step}`}
            data-step={item.step}
            className="punchy-slide min-h-[90vh] sm:min-h-screen flex items-center justify-center px-4 sm:px-6 py-20 border-b border-white/5 relative overflow-hidden"
          >
            ...
            <div className="relative z-10 max-w-4xl mx-auto w-full text-center">
              ...
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-mono font-medium border mb-6 backdrop-blur-md">
              ...
              {/* Feature Details Box */}
              <div className="p-6 sm:p-8 rounded-2xl bg-[#15111D]/90 border border-white/10 max-w-xl mx-auto backdrop-blur-md shadow-2xl shadow-black/80 text-left mb-8">
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-11 h-11 rounded-xl bg-[#1F192A] border border-white/10 flex items-center justify-center shrink-0">
                  ...
                  <div className="p-6 rounded-2xl bg-gradient-to-br from-[#F5B301]/20 via-[#15111D] to-[#FF7A1A]/10 border-2 border-[#F5B301] glow-nova-card-blazing shadow-2xl">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                      <div className="text-left">
                        <div className="flex items-center gap-2 text-xs font-mono text-[#F5B301] uppercase tracking-wider font-bold mb-1">
                          <Sparkles className="w-4 h-4 text-[#F5B301] animate-spin" />
                      ...
                      <button
                        ...
                        className="px-6 py-3.5 rounded-xl text-sm font-black font-display text-[#08060B] bg-gradient-to-r from-[#F5B301] via-[#FFC107] to-[#FF7A1A] hover:brightness-110 shadow-xl shadow-[#F5B301]/40 transition-all transform hover:scale-105 cursor-pointer whitespace-nowrap"
                      >
